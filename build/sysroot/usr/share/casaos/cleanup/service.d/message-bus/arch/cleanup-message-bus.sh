...
readonly CASA_SERVICES=(
    "dappsteros-message-bus.service"
)

readonly CASA_EXEC=dappsteros-message-bus
readonly CASA_CONF=/etc/dappsteros/message-bus.conf
readonly CASA_DB=/var/lib/dappsteros/db/message-bus.db
