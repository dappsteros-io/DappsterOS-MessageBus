...
import (
	...
	"github.com/dappsteros-io/DappsterOS-MessageBus/config"
	"github.com/dappsteros-io/DappsterOS-MessageBus/repository"
	"github.com/dappsteros-io/DappsterOS-MessageBus/route"
...
var (
	...
	//go:embed build/sysroot/etc/dappsteros/message-bus.conf.sample
	_confSample string
